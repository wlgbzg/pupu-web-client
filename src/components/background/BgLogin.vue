<template>
    <svg style="position: absolute; width: 100%; height: 100vh; z-index: -1" preserveAspectRatio="xMinYMin slice"
         xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1700 1200">
        <defs>
