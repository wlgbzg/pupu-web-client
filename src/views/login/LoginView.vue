  ...
  <div class='login-container'>
    ...
    <div class='login-box'>
      ...
      <div class='login-form'>
        ...
        <div v-if='formIndex === 1' class='form-box'>
          <el-form ref='codeFormRef' :model='codeForm' :rules='codeRules' label-position='top' label-width='100px' style='max-width: 460px'>
            <el-form-item label='手机号码' prop='phone'>
              <el-input v-model='codeForm.phone' clearable maxlength='11' oninput="value=value.replace(/\D/g,'')" />
            </el-form-item>
            <el-form-item label='短信验证码' prop='code'>
              <div class='code-box'>
                <el-input v-model='codeForm.verifyCode' class='code-box-left' clearable maxlength='6' oninput="value=value.replace(/\D/g,'')" />
                <el-button :disabled='codeBtnStore.disable' @click='submitSendCodeForm(codeFormRef)'><span v-if='codeBtnStore.counter == 0'>发送验证码</span> <span
                  v-if='codeBtnStore.counter != 0'> 重新发送 ({{ codeBtnStore.counter }})</span></el-button>
              </div>
            </el-form-item>
            <el-form-item label=''>
            ...
            <el-form-item class='form' label=''>
              <el-button class='btn-change' link type='primary' @click='changeFormIndex(2)'>使用密码登录
              </el-button>
            </el-form-item>
          </el-form>
        </div>

        <div v-if='formIndex === 2' class='form-box'>
          <el-form ref='passwordFormRef' :model='passwordForm' :rules='passwordRules' label-position='top' label-width='100px' style='max-width: 460px'>
            <el-form-item label='手机号码' prop='phone'>
              <el-input v-model='passwordForm.phone' clearable maxlength='11' oninput="value=value.replace(/\D/g,'')" />
            </el-form-item>
            <el-form-item label='密码' prop='password'>
              <el-input v-model='passwordForm.password' clearable show-password />
            </el-form-item>
            <el-form-item label=''>
              <el-button link type='primary'>忘记密码？</el-button>
            </el-form-item>
            ...
            <el-form-item class='form' label=''>
              <el-button class='btn-change' link type='primary' @click='changeFormIndex(1)'>使用短信验证码登录</el-button>
            </el-form-item>
          </el-form>
        </div>
      </div>
      <div class='login-qrcode-box'>
        <div class='qrcode'>
          <qrcode-vue margin='2' size='176' value='通过Discord手机App扫描二维码。'></qrcode-vue>
        </div>
        <h2>通过二维码登录</h2>
