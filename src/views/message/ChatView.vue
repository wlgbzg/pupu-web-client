  ...
  <div class='no-channel-container '>
    ...
    <div class='input-container'>
      ...
      <div class='input-view'>
        <textarea ref='textareaRef' v-model='content' :placeholder="'给 #' + channel?.name + ' 发消息'" :rows='rows' class='input-textarea' @keydown.enter='handleInputEnterKey' />
      </div>
...
<script lang='ts' setup>
  ...
  import IconHelp from '@/components/icons/chat/IconHelp.vue'
  import IconMember from '@/components/icons/chat/IconMember.vue'
  import IconMark from '@/components/icons/chat/IconMark.vue'
  import IconNotify from '@/components/icons/chat/IconNotify.vue'
  import IconSubZone from '@/components/icons/chat/IconSubZone.vue'
  import IconAdd from '@/components/icons/chat/IconAdd.vue'
  import IconSticker from '@/components/icons/chat/IconSticker.vue'
  import IconGif from '@/components/icons/chat/IconGif.vue'
  import IconGift from '@/components/icons/chat/IconGift.vue'
